...
m2 = Movie.find_by(title: "Avengers: Endgame")
m2.reviews.create!(name: "Jordi", stars: 5, comment: "I love the movie!")
m2.reviews.create!(name: "Ana", stars: 4, comment: "Good movie!")
m2.reviews.create!(name: "Leo", stars: 3, comment: "I would watch it again!")

m3 = Movie.find_by(title: "Black Panther")
m3.reviews.create!(name: "Jordi", stars: 1, comment: "I felt asleep!")
m3.reviews.create!(name: "Ana", stars: 2, comment: "Pseeee!")
m3.reviews.create!(name: "Leo", stars: 4, comment: "I want to be like black panther")

m4 = Movie.find_by(title: "Avengers: Infinity War")
m4.reviews.create!(name: "Jordi", stars: 5, comment: "I love the movie!")

m5 = Movie.find_by(title: "Superman")
m5.reviews.create!(name: "Ana", stars: 2, comment: "Old school movie!")
m5.reviews.create!(name: "Leo", stars: 3, comment: "I would not watch it again!")

# This creates a handful of example movie genres
...
# Chapter 42 (Part 2)
# If you want to run these Active Storage migration seeds then the image_file_name attribute has to be removed from Movie.create!([
[
